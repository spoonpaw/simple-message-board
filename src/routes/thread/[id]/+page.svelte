...
<script lang="ts">
	...
	import { ArrowLeftCircle, Lock, Pencil, Pin, Trash2 } from '@steeze-ui/lucide-icons';
	...
	function closeNewPostModal() {
		newPostModal = false;
		// Reset the new post content when the modal is closed
		newPostContent = '';
	}
...
<div class="min-h-screen bg-gray-50">
	...
	{#if !thread.locked && isLoggedIn}
		<!-- New Post Modal -->
		<Modal open={newPostModal} title="Add a Reply" on:close={closeNewPostModal}>
			<div slot="body">
